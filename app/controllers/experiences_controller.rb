...
if @experience.save
  ...
  private
    ...
    def experience_params
      params.require(:experience).permit(:title, :description, :vista, :olfato, :gusto, :oido, :gusto, :latitude, :longitude, :expe, :money, :currency, :aprox_time, :gente, :idioma, :is_risky, :is_internet, :is_reservation, :website, :advice, :nomad_id)
    end
end
